...
# Instanciation de la variable choix au départ
choix = " "
while choix != "y":

    # Instanciation de la variable choix si boucle
    choix = " "
    ...
    if NBC < 5 and NbGoulotte < 3.2:
        ...
        if NbGoulotte > 1.2:
            ...
            print(
                "> Parfait pour cette configuration en terme de hauteur de canaux, ce produit nécessitera précisement",
